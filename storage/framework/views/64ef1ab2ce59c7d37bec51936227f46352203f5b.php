...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo e(asset('public/fonts/font-awesome.min.css')); ?>">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo e(asset('public/fonts/ionicons.min.css')); ?>">
  <!-- Theme style -->
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo e(asset('public/dist/img/user2-160x160.jpg')); ?>" class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo e(Auth::user()->name); ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?php echo e(asset('public/dist/img/user2-160x160.jpg')); ?>" class="img-circle" alt="User Image">
                  ...
                  <p>
                    ...
                    <small>Bergabung Sejak, 
                      <?php if(Auth::user()->created_at != null): ?>
                      <?php echo e(Auth::user()->created_at->format('m')); ?>-<?php echo e(Auth::user()->created_at->format('Y')); ?>,
                      <?php else: ?>
                      -
                      <?php endif; ?>
                ...
                <li class="user-footer">               
                  <div class="pull-right">    
                    ...
                    <a class="btn btn-danger btn-sm btn-flat" href="<?php echo e(route('logout')); ?>"
    ...
    <ul class="sidebar-menu">
     ...
     <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href=" <?php echo e(route('users')); ?> "><i class="fa fa-users"></i> User</a></li>
      </ul> 
      <ul class="treeview-menu">
        <li><a href="<?php echo e(route('products.index')); ?> "><i class="fa fa-dropbox"></i> Produk</a></li>
      </ul>
    </li>
...
<div class="content-wrapper">
 <?php echo $__env->make('template.contentheader', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
 <!-- Main content -->
